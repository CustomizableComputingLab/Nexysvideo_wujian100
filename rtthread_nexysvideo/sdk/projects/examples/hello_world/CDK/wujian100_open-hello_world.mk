...
IncludePackagePath     :=
IncludeCPath           := $(IncludeSwitch). $(IncludeSwitch)../../../../board/wujian100_open_evb/include $(IncludeSwitch)../../../../csi_core/include $(IncludeSwitch)../../../../csi_driver/include $(IncludeSwitch)../../../../csi_driver/wujian100_open/include $(IncludeSwitch)../../../../csi_kernel/include $(IncludeSwitch)../../../../libs/include $(IncludeSwitch)../configs $(IncludeSwitch)rttos2wujian100 $(IncludeSwitch)rttos2wujian100/components/finsh $(IncludeSwitch)rttos2wujian100/include $(IncludeSwitch)rttos2wujian100/include/libc $(IncludeSwitch)rttos2wujian100/libcpu/common  
IncludeAPath           := $(IncludeSwitch). $(IncludeSwitch)../configs $(IncludeSwitch)rttos2wujian100 $(IncludeSwitch)rttos2wujian100/components/finsh $(IncludeSwitch)rttos2wujian100/include $(IncludeSwitch)rttos2wujian100/include/libc $(IncludeSwitch)rttos2wujian100/libcpu/common  
...
$(IntermediateDirectory)/$(OutputFile):  $(Objects) Always_Link 
	$(LinkerName) $(OutputSwitch) $(IntermediateDirectory)/$(OutputFile)$(ExeSuffix) $(LinkerNameoption) $(LinkOtherFlagsOption)  @$(ObjectsFileList) $(LibraryPathSwitch)C:/Users/hnaym/Desktop/T_head_data/nexys_video/rtthread_nexysvideo/sdk/libs  -Wl,--whole-archive $(LibrarySwitch)newlib_wrap   -Wl,--no-whole-archive  $(LinkOptions) $(LibPath) $(Libs)
...
## Objects
##
$(IntermediateDirectory)/rttos2wujian100_board$(ObjectSuffix): rttos2wujian100/board.c  
	$(CC) $(SourceSwitch) rttos2wujian100/board.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/rttos2wujian100_board$(ObjectSuffix) -MF$(IntermediateDirectory)/rttos2wujian100_board$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/rttos2wujian100_board$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/rttos2wujian100_board$(PreprocessSuffix): rttos2wujian100/board.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/rttos2wujian100_board$(PreprocessSuffix) rttos2wujian100/board.c
...
$(IntermediateDirectory)/src_clock$(ObjectSuffix): rttos2wujian100/src/clock.c  
	$(CC) $(SourceSwitch) rttos2wujian100/src/clock.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_clock$(ObjectSuffix) -MF$(IntermediateDirectory)/src_clock$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_clock$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_clock$(PreprocessSuffix): rttos2wujian100/src/clock.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_clock$(PreprocessSuffix) rttos2wujian100/src/clock.c

$(IntermediateDirectory)/src_components$(ObjectSuffix): rttos2wujian100/src/components.c  
	$(CC) $(SourceSwitch) rttos2wujian100/src/components.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_components$(ObjectSuffix) -MF$(IntermediateDirectory)/src_components$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_components$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_components$(PreprocessSuffix): rttos2wujian100/src/components.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_components$(PreprocessSuffix) rttos2wujian100/src/components.c

$(IntermediateDirectory)/src_cpu$(ObjectSuffix): rttos2wujian100/src/cpu.c  
	$(CC) $(SourceSwitch) rttos2wujian100/src/cpu.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_cpu$(ObjectSuffix) -MF$(IntermediateDirectory)/src_cpu$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_cpu$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_cpu$(PreprocessSuffix): rttos2wujian100/src/cpu.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_cpu$(PreprocessSuffix) rttos2wujian100/src/cpu.c

$(IntermediateDirectory)/src_idle$(ObjectSuffix): rttos2wujian100/src/idle.c  
	$(CC) $(SourceSwitch) rttos2wujian100/src/idle.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_idle$(ObjectSuffix) -MF$(IntermediateDirectory)/src_idle$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_idle$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_idle$(PreprocessSuffix): rttos2wujian100/src/idle.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_idle$(PreprocessSuffix) rttos2wujian100/src/idle.c

$(IntermediateDirectory)/src_ipc$(ObjectSuffix): rttos2wujian100/src/ipc.c  
	$(CC) $(SourceSwitch) rttos2wujian100/src/ipc.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_ipc$(ObjectSuffix) -MF$(IntermediateDirectory)/src_ipc$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_ipc$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_ipc$(PreprocessSuffix): rttos2wujian100/src/ipc.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_ipc$(PreprocessSuffix) rttos2wujian100/src/ipc.c

$(IntermediateDirectory)/src_irq$(ObjectSuffix): rttos2wujian100/src/irq.c  
	$(CC) $(SourceSwitch) rttos2wujian100/src/irq.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_irq$(ObjectSuffix) -MF$(IntermediateDirectory)/src_irq$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_irq$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_irq$(PreprocessSuffix): rttos2wujian100/src/irq.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_irq$(PreprocessSuffix) rttos2wujian100/src/irq.c

$(IntermediateDirectory)/src_kservice$(ObjectSuffix): rttos2wujian100/src/kservice.c  
	$(CC) $(SourceSwitch) rttos2wujian100/src/kservice.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_kservice$(ObjectSuffix) -MF$(IntermediateDirectory)/src_kservice$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_kservice$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_kservice$(PreprocessSuffix): rttos2wujian100/src/kservice.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_kservice$(PreprocessSuffix) rttos2wujian100/src/kservice.c

$(IntermediateDirectory)/src_mem$(ObjectSuffix): rttos2wujian100/src/mem.c  
	$(CC) $(SourceSwitch) rttos2wujian100/src/mem.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_mem$(ObjectSuffix) -MF$(IntermediateDirectory)/src_mem$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_mem$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_mem$(PreprocessSuffix): rttos2wujian100/src/mem.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_mem$(PreprocessSuffix) rttos2wujian100/src/mem.c

$(IntermediateDirectory)/src_memheap$(ObjectSuffix): rttos2wujian100/src/memheap.c  
	$(CC) $(SourceSwitch) rttos2wujian100/src/memheap.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_memheap$(ObjectSuffix) -MF$(IntermediateDirectory)/src_memheap$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_memheap$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_memheap$(PreprocessSuffix): rttos2wujian100/src/memheap.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_memheap$(PreprocessSuffix) rttos2wujian100/src/memheap.c

$(IntermediateDirectory)/src_mempool$(ObjectSuffix): rttos2wujian100/src/mempool.c  
	$(CC) $(SourceSwitch) rttos2wujian100/src/mempool.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_mempool$(ObjectSuffix) -MF$(IntermediateDirectory)/src_mempool$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_mempool$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_mempool$(PreprocessSuffix): rttos2wujian100/src/mempool.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_mempool$(PreprocessSuffix) rttos2wujian100/src/mempool.c

$(IntermediateDirectory)/src_object$(ObjectSuffix): rttos2wujian100/src/object.c  
	$(CC) $(SourceSwitch) rttos2wujian100/src/object.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_object$(ObjectSuffix) -MF$(IntermediateDirectory)/src_object$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_object$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_object$(PreprocessSuffix): rttos2wujian100/src/object.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_object$(PreprocessSuffix) rttos2wujian100/src/object.c

$(IntermediateDirectory)/src_scheduler$(ObjectSuffix): rttos2wujian100/src/scheduler.c  
	$(CC) $(SourceSwitch) rttos2wujian100/src/scheduler.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_scheduler$(ObjectSuffix) -MF$(IntermediateDirectory)/src_scheduler$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_scheduler$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_scheduler$(PreprocessSuffix): rttos2wujian100/src/scheduler.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_scheduler$(PreprocessSuffix) rttos2wujian100/src/scheduler.c

$(IntermediateDirectory)/src_slab$(ObjectSuffix): rttos2wujian100/src/slab.c  
	$(CC) $(SourceSwitch) rttos2wujian100/src/slab.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_slab$(ObjectSuffix) -MF$(IntermediateDirectory)/src_slab$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_slab$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_slab$(PreprocessSuffix): rttos2wujian100/src/slab.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_slab$(PreprocessSuffix) rttos2wujian100/src/slab.c

$(IntermediateDirectory)/src_thread$(ObjectSuffix): rttos2wujian100/src/thread.c  
	$(CC) $(SourceSwitch) rttos2wujian100/src/thread.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_thread$(ObjectSuffix) -MF$(IntermediateDirectory)/src_thread$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_thread$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_thread$(PreprocessSuffix): rttos2wujian100/src/thread.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_thread$(PreprocessSuffix) rttos2wujian100/src/thread.c

$(IntermediateDirectory)/src_timer$(ObjectSuffix): rttos2wujian100/src/timer.c  
	$(CC) $(SourceSwitch) rttos2wujian100/src/timer.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_timer$(ObjectSuffix) -MF$(IntermediateDirectory)/src_timer$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_timer$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_timer$(PreprocessSuffix): rttos2wujian100/src/timer.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_timer$(PreprocessSuffix) rttos2wujian100/src/timer.c

$(IntermediateDirectory)/src_ringbuffer_RTtread$(ObjectSuffix): rttos2wujian100/src/ringbuffer_RTtread.c  
	$(CC) $(SourceSwitch) rttos2wujian100/src/ringbuffer_RTtread.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_ringbuffer_RTtread$(ObjectSuffix) -MF$(IntermediateDirectory)/src_ringbuffer_RTtread$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_ringbuffer_RTtread$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_ringbuffer_RTtread$(PreprocessSuffix): rttos2wujian100/src/ringbuffer_RTtread.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_ringbuffer_RTtread$(PreprocessSuffix) rttos2wujian100/src/ringbuffer_RTtread.c

$(IntermediateDirectory)/src_finsh_e902$(ObjectSuffix): rttos2wujian100/src/finsh_e902.c  
	$(CC) $(SourceSwitch) rttos2wujian100/src/finsh_e902.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/src_finsh_e902$(ObjectSuffix) -MF$(IntermediateDirectory)/src_finsh_e902$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/src_finsh_e902$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/src_finsh_e902$(PreprocessSuffix): rttos2wujian100/src/finsh_e902.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/src_finsh_e902$(PreprocessSuffix) rttos2wujian100/src/finsh_e902.c
...
$(IntermediateDirectory)/finsh_cmd$(ObjectSuffix): rttos2wujian100/components/finsh/cmd.c  
	$(CC) $(SourceSwitch) rttos2wujian100/components/finsh/cmd.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/finsh_cmd$(ObjectSuffix) -MF$(IntermediateDirectory)/finsh_cmd$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/finsh_cmd$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/finsh_cmd$(PreprocessSuffix): rttos2wujian100/components/finsh/cmd.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/finsh_cmd$(PreprocessSuffix) rttos2wujian100/components/finsh/cmd.c

$(IntermediateDirectory)/finsh_msh$(ObjectSuffix): rttos2wujian100/components/finsh/msh.c  
	$(CC) $(SourceSwitch) rttos2wujian100/components/finsh/msh.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/finsh_msh$(ObjectSuffix) -MF$(IntermediateDirectory)/finsh_msh$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/finsh_msh$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/finsh_msh$(PreprocessSuffix): rttos2wujian100/components/finsh/msh.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/finsh_msh$(PreprocessSuffix) rttos2wujian100/components/finsh/msh.c

$(IntermediateDirectory)/finsh_shell$(ObjectSuffix): rttos2wujian100/components/finsh/shell.c  
	$(CC) $(SourceSwitch) rttos2wujian100/components/finsh/shell.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/finsh_shell$(ObjectSuffix) -MF$(IntermediateDirectory)/finsh_shell$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/finsh_shell$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/finsh_shell$(PreprocessSuffix): rttos2wujian100/components/finsh/shell.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/finsh_shell$(PreprocessSuffix) rttos2wujian100/components/finsh/shell.c

$(IntermediateDirectory)/common_context_gcc$(ObjectSuffix): rttos2wujian100/libcpu/common/context_gcc.S  
	$(AS) $(SourceSwitch) rttos2wujian100/libcpu/common/context_gcc.S $(ASFLAGS) -MMD -MP -MT$(IntermediateDirectory)/common_context_gcc$(ObjectSuffix) -MF$(IntermediateDirectory)/common_context_gcc$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/common_context_gcc$(ObjectSuffix) $(IncludeAPath) $(IncludePackagePath)
Lst/common_context_gcc$(PreprocessSuffix): rttos2wujian100/libcpu/common/context_gcc.S
	$(CC) $(CFLAGS)$(IncludeAPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/common_context_gcc$(PreprocessSuffix) rttos2wujian100/libcpu/common/context_gcc.S

$(IntermediateDirectory)/common_cpuport$(ObjectSuffix): rttos2wujian100/libcpu/common/cpuport.c  
	$(CC) $(SourceSwitch) rttos2wujian100/libcpu/common/cpuport.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/common_cpuport$(ObjectSuffix) -MF$(IntermediateDirectory)/common_cpuport$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/common_cpuport$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/common_cpuport$(PreprocessSuffix): rttos2wujian100/libcpu/common/cpuport.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/common_cpuport$(PreprocessSuffix) rttos2wujian100/libcpu/common/cpuport.c

$(IntermediateDirectory)/e902_test_interrupt_gcc$(ObjectSuffix): rttos2wujian100/libcpu/e902_test/interrupt_gcc.S  
	$(AS) $(SourceSwitch) rttos2wujian100/libcpu/e902_test/interrupt_gcc.S $(ASFLAGS) -MMD -MP -MT$(IntermediateDirectory)/e902_test_interrupt_gcc$(ObjectSuffix) -MF$(IntermediateDirectory)/e902_test_interrupt_gcc$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/e902_test_interrupt_gcc$(ObjectSuffix) $(IncludeAPath) $(IncludePackagePath)
Lst/e902_test_interrupt_gcc$(PreprocessSuffix): rttos2wujian100/libcpu/e902_test/interrupt_gcc.S
	$(CC) $(CFLAGS)$(IncludeAPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/e902_test_interrupt_gcc$(PreprocessSuffix) rttos2wujian100/libcpu/e902_test/interrupt_gcc.S
