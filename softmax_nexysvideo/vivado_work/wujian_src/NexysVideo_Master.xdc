...
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets {x_cpu_top/CPU/x_cr_core_top/x_cr_core/x_cr_ifu_top/x_ibuf/x_ibuf_entry_0/pcgen_cur_pc_reg[30]_1}]

## Clock Signal
set_property -dict { PACKAGE_PIN R4    IOSTANDARD LVCMOS33 } [get_ports { PIN_EHS }]; #IO_L13P_T2_MRCC_34 Sch=sysclk
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports PIN_EHS]
...
## LEDs         FOR SOFT SPI TEST
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS25 } [get_ports { POUT_EHS }]; #IO_L15P_T2_DQS_13 Sch=led[0]
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS25 } [get_ports { PAD_GPIO_1 }]; #IO_L15N_T2_DQS_13 Sch=led[1]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS25 } [get_ports { PAD_GPIO_2 }]; #IO_L17P_T2_13 Sch=led[2]
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS25 } [get_ports { PAD_USI2_NSS }]; #IO_L17N_T2_13 Sch=led[3]
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS25 } [get_ports { PAD_PWM_CH9 }]; #IO_L14N_T2_SRCC_13 Sch=led[4]
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS25 } [get_ports { PAD_GPIO_0 }]; #IO_L16N_T2_13 Sch=led[5]
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS25 } [get_ports { PAD_USI0_NSS }]; #IO_L16P_T2_13 Sch=led[6]
set_property -dict { PACKAGE_PIN Y13   IOSTANDARD LVCMOS25 } [get_ports { PAD_USI0_SD1 }]; #IO_L5P_T0_13 Sch=led[7]
...
set_property -dict { PACKAGE_PIN F15 IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_12 }]; #IO_0_16 Sch=btnu
set_property -dict { PACKAGE_PIN G4  IOSTANDARD LVCMOS15 } [get_ports { PAD_MCURST }]; #IO_L12N_T1_MRCC_35 Sch=cpu_resetn


## Switches  29 30 31
set_property -dict { PACKAGE_PIN E22  IOSTANDARD LVCMOS33 } [get_ports { PAD_PWM_CH10 }]; #IO_L22P_T3_16 Sch=sw[0]
set_property -dict { PACKAGE_PIN F21  IOSTANDARD LVCMOS33 } [get_ports { PAD_PWM_CH11 }]; #IO_25_16 Sch=sw[1]
set_property -dict { PACKAGE_PIN G21  IOSTANDARD LVCMOS33 } [get_ports { PAD_PWM_CH0 }]; #IO_L24P_T3_16 Sch=sw[2]
set_property -dict { PACKAGE_PIN G22  IOSTANDARD LVCMOS33 } [get_ports { PAD_PWM_CH1 }]; #IO_L24N_T3_16 Sch=sw[3]
...
set_property -dict { PACKAGE_PIN V22   IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_26 }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=oled_vdd
...
#set_property -dict { PACKAGE_PIN T5    IOSTANDARD LVCMOS33 } [get_ports { ac_bclk }]7; #IO_L14P_T2_SRCC_34 Sch=ac_bclk
#set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { ac_dac_sda7ta }]; #IO_L15P_T2_DQS_34 Sch=ac_dac_sdata
#set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { ac_lrclk }7]; #IO_L14N_T2_SRCC_34 Sch=ac_lrclk
#set_property -dict { PACKAGE_PIN U6    IOSTANDARD LVCMOS33 } [get_ports { ac_mclk }]7; #IO_L16P_T2_34 Sch=ac_mcl7k7


### SD card
#set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { PAD_USI2_SCLK }]; #IO_L12P_T1_MRCC_14 Sch=sd_cclk         sclk
#set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_18 }]; #IO_L20N_T3_A07_D23_14 Sch=sd_cd          card detect
#set_property -dict { PACKAGE_PIN W20   IOSTANDARD LVCMOS33 } [get_ports { PAD_USI2_SD0 }]; #IO_L12N_T1_MRCC_14 Sch=sd_cmd           mosi
#set_property -dict { PACKAGE_PIN V19   IOSTANDARD LVCMOS33 } [get_ports { PAD_USI2_SD1 }]; #IO_L14N_T2_SRCC_14 Sch=sd_d[0]          miso
...
#set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_19 }]; #IO_L18N_T2_A11_D27_14 Sch=sd_d[3]        cs
#set_property -dict { PACKAGE_PIN V20   IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_20 }]; #IO_L11N_T1_SRCC_14 Sch=sd_reset          rst 

## Pmod header 7JA
#set_property -dict { PACKAGE_PIN AB22  IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_27 }]; #IO_L10N_T1_D15_14 Sch=ja[1]
#set_property -dict { PACKAGE_PIN AB21  IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_28 }]; #IO_L10P_T1_D14_14 Sch=ja[2]
#set_property -dict { PACKAGE_PIN AB20  IOSTANDARD LVCMOS33 } [get_ports { PAD_USI1_SD0 }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=ja[3]
#set_property -dict { PACKAGE_PIN AB18  IOSTANDARD LVCMOS33 } [get_ports { PAD_USI1_SCLK }]; #IO_L17N_T2_A13_D29_14 Sch=ja[4]
#set_property -dict { PACKAGE_PIN Y21   IOSTANDARD LVCMOS33 } [get_ports { PAD_USI1_SD1 }]; #IO_L9P_T1_DQS_14 Sch=ja[7]
#set_property -dict { PACKAGE_PIN AA21  IOSTANDARD LVCMOS33 } [get_ports { PAD_PWM_CH0 }]; #IO_L8N_T1_D12_14 Sch=ja[8]
#set_property -dict { PACKAGE_PIN AA20  IOSTANDARD LVCMOS33 } [get_ports { PAD_PWM_CH1 }]; #IO_L8P_T1_D11_14 Sch=ja[9]
#set_property -dict { PACKAGE_PIN AA18  IOSTANDARD LVCMOS33 } [get_ports { PAD_PWM_CH2 }]; #IO_L17P_T2_A14_D30_14 Sch=ja[10]


### Pmod header 7JA    USI2 SPI TEST
#set_property -dict { PACKAGE_PIN AB22  IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_20 }]; #IO_L10N_T1_D15_14 Sch=ja[1]
#set_property -dict { PACKAGE_PIN AB21  IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_19 }]; #IO_L10P_T1_D14_14 Sch=ja[2]
#set_property -dict { PACKAGE_PIN AB20  IOSTANDARD LVCMOS33 } [get_ports { PAD_USI2_SD0 }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=ja[3]
#set_property -dict { PACKAGE_PIN AB18  IOSTANDARD LVCMOS33 } [get_ports { PAD_USI2_SCLK }]; #IO_L17N_T2_A13_D29_14 Sch=ja[4]
#set_property -dict { PACKAGE_PIN Y21   IOSTANDARD LVCMOS33 } [get_ports { PAD_USI2_SD1 }]; #IO_L9P_T1_DQS_14 Sch=ja[7]
#set_property -dict { PACKAGE_PIN AA21  IOSTANDARD LVCMOS33 } [get_ports { PAD_PWM_CH0 }]; #IO_L8N_T1_D12_14 Sch=ja[8]
#set_property -dict { PACKAGE_PIN AA20  IOSTANDARD LVCMOS33 } [get_ports { PAD_PWM_CH1 }]; #IO_L8P_T1_D11_14 Sch=ja[9]
#set_property -dict { PACKAGE_PIN AA18  IOSTANDARD LVCMOS33 } [get_ports { PAD_PWM_CH2 }]; #IO_L17P_T2_A14_D30_14 Sch=ja[10]
...
#set_property -dict { PACKAGE_PIN AB22  IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_20 }]; #IO_L10N_T1_D15_14 Sch=ja[1]          rst
#set_property -dict { PACKAGE_PIN AB21  IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_19 }]; #IO_L10P_T1_D14_14 Sch=ja[2]          cs  
#set_property -dict { PACKAGE_PIN AB20  IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_5}]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=ja[3] mosi
#set_property -dict { PACKAGE_PIN AB18  IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_6}]; #IO_L17N_T2_A13_D29_14 Sch=ja[4]        clk 
#set_property -dict { PACKAGE_PIN Y21   IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_7}]; #IO_L9P_T1_DQS_14 Sch=ja[7]             miso
#set_property -dict { PACKAGE_PIN AA21  IOSTANDARD LVCMOS33 } [get_ports { PAD_PWM_CH0 }]; #IO_L8N_T1_D12_14 Sch=ja[8]
#set_property -dict { PACKAGE_PIN AA20  IOSTANDARD LVCMOS33 } [get_ports { PAD_PWM_CH1 }]; #IO_L8P_T1_D11_14 Sch=ja[9]
#set_property -dict { PACKAGE_PIN AA18  IOSTANDARD LVCMOS33 } [get_ports { PAD_PWM_CH2 }]; #IO_L17P_T2_A14_D30_14 Sch=ja[10]
...
## Pmod header JC                   
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33 } [get_ports { PAD_USI1_NSS }]; #IO_L18P_T2_34 Sch=jc_p[1]                        
set_property -dict { PACKAGE_PIN AA6   IOSTANDARD LVCMOS33 } [get_ports { PAD_USI1_SCLK  }]; #IO_L18N_T2_34 Sch=jc_n[1]
set_property -dict { PACKAGE_PIN AA8   IOSTANDARD LVCMOS33 } [get_ports { PAD_USI1_SD0 }]; #IO_L22P_T3_34 Sch=jc_p[2]
set_property -dict { PACKAGE_PIN AB8   IOSTANDARD LVCMOS33 } [get_ports { PAD_USI1_SD1 }]; #IO_L22N_T3_34 Sch=jc_n[2]
set_property -dict { PACKAGE_PIN R6    IOSTANDARD LVCMOS33 } [get_ports { PAD_USI2_SCLK }]; #IO_L17P_T2_34 Sch=jc_p[3]
set_property -dict { PACKAGE_PIN T6    IOSTANDARD LVCMOS33 } [get_ports { PAD_USI2_SD1 }]; #IO_L17N_T2_34 Sch=jc_n[3]
set_property -dict { PACKAGE_PIN AB7   IOSTANDARD LVCMOS33 } [get_ports { PAD_USI2_SD0 }]; #IO_L20P_T3_34 Sch=jc_p[4]
set_property -dict { PACKAGE_PIN AB6   IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_4 }]; #IO_L20N_T3_34 Sch=jc_n[4]
...
## UART
set_property -dict { PACKAGE_PIN AA19  IOSTANDARD LVCMOS33 } [get_ports { PAD_USI0_SD0 }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=uart_rx_out
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { PAD_USI0_SCLK }]; #IO_L14P_T2_SRCC_14 Sch=uart_tx_in
...
## Fan PWM
set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS25 } [get_ports { PAD_PWM_FAULT }]; #IO_L14P_T2_SRCC_13 Sch=fan_pwm
...
set_property -dict { PACKAGE_PIN AB20  IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_3  }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=ja[3] mosi
...
## SD card
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_6 }]; #IO_L12P_T1_MRCC_14 Sch=sd_cclk         sclk        PAD_GPIO_6
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_18 }]; #IO_L20N_T3_A07_D23_14 Sch=sd_cd          card detect
set_property -dict { PACKAGE_PIN W20   IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_5 }]; #IO_L12N_T1_MRCC_14 Sch=sd_cmd           mosi        PAD_GPIO_5
set_property -dict { PACKAGE_PIN V19   IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_7 }]; #IO_L14N_T2_SRCC_14 Sch=sd_d[0]          miso        PAD_GPIO_7
#set_property -dict { PACKAGE_PIN T21   IOSTANDARD LVCMOS33 } [get_ports { sd_d[1] }]; #IO_L4P_T0_D04_14 Sch=sd_d[1]
#set_property -dict { PACKAGE_PIN T20   IOSTANDARD LVCMOS33 } [get_ports { sd_d[2] }]; #IO_L6N_T0_D08_VREF_14 Sch=sd_d[2]   
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_19 }]; #IO_L18N_T2_A11_D27_14 Sch=sd_d[3]        cs          PAD_GPIO_19
set_property -dict { PACKAGE_PIN V20   IOSTANDARD LVCMOS33 } [get_ports { PAD_GPIO_20 }]; #IO_L11N_T1_SRCC_14 Sch=sd_reset          rst         PAD_GPIO_20


## I2C
#set_property -dict { PACKAGE_PIN W5    IOSTANDARD LVCMOS33 } [get_ports { PAD_USI1_SCLK }]; #IO_L15N_T2_DQS_34 Sch=scl
#set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { PAD_USI1_SD0 }]; #IO_L16N_T2_34 Sch=sda
