...
IncludePackagePath     :=
IncludeCPath           := $(IncludeSwitch). $(IncludeSwitch)../../../../board/wujian100_open_evb/include $(IncludeSwitch)../../../../csi_core/include $(IncludeSwitch)../../../../csi_driver/include $(IncludeSwitch)../../../../csi_driver/wujian100_open/include $(IncludeSwitch)../../../../csi_kernel/include $(IncludeSwitch)../../../../libs/include $(IncludeSwitch)../../hello_world/configs $(IncludeSwitch)../oled128_32 $(IncludeSwitch)../sd_driver $(IncludeSwitch)../softmax $(IncludeSwitch)../vs1053  
IncludeAPath           := $(IncludeSwitch). $(IncludeSwitch)../../hello_world/configs $(IncludeSwitch)../oled128_32 $(IncludeSwitch)../sd_driver $(IncludeSwitch)../softmax $(IncludeSwitch)../vs1053  
...
$(IntermediateDirectory)/spi_sd_main$(ObjectSuffix): ../main.c  
	$(CC) $(SourceSwitch) ../main.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/spi_sd_main$(ObjectSuffix) -MF$(IntermediateDirectory)/spi_sd_main$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/spi_sd_main$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/spi_sd_main$(PreprocessSuffix): ../main.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/spi_sd_main$(PreprocessSuffix) ../main.c
...
$(IntermediateDirectory)/vs1053_vs1053$(ObjectSuffix): ../vs1053/vs1053.c  
	$(CC) $(SourceSwitch) ../vs1053/vs1053.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/vs1053_vs1053$(ObjectSuffix) -MF$(IntermediateDirectory)/vs1053_vs1053$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/vs1053_vs1053$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/vs1053_vs1053$(PreprocessSuffix): ../vs1053/vs1053.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/vs1053_vs1053$(PreprocessSuffix) ../vs1053/vs1053.c

$(IntermediateDirectory)/softmax_softmax$(ObjectSuffix): ../softmax/softmax.c  
	$(CC) $(SourceSwitch) ../softmax/softmax.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/softmax_softmax$(ObjectSuffix) -MF$(IntermediateDirectory)/softmax_softmax$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/softmax_softmax$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/softmax_softmax$(PreprocessSuffix): ../softmax/softmax.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/softmax_softmax$(PreprocessSuffix) ../softmax/softmax.c
